...
<div class="container text-center">
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
          <div class="container-fluid">
            <a class="navbar-brand" href="#"><h1 class="nav text-center">La liste des niveaux existes</h1>
      ...
      <table class="table table-striped table-bordered">
        <thead>
          ...
          <tr>
            ...
            <td>
              <a href="/ajoute"class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
              ...
              <a href="/update-niveau/{{ $niveau->id }}" class= "btn btn-success"><svg xmlns="" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
              ...
              <a href="delete-niveau/{{ $niveau->id }}" class= "btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-archive-fill" viewBox="0 0 16 16">
